...
The project is for PR2 Robot perception pipeline for object detection of point cloud (pcl). The perception pipeline will go through some pcl filtering and Ecludian clustering for segmentation then object detection using a SVM training set.
