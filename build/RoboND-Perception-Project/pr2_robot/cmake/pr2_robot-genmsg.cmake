...
get_filename_component(_filename "/home/asd/Downloads/3D_Perception/src/RoboND-Perception-Project/pr2_robot/srv/PickPlace.srv" NAME_WE)
add_custom_target(_pr2_robot_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "pr2_robot" "/home/asd/Downloads/3D_Perception/src/RoboND-Perception-Project/pr2_robot/srv/PickPlace.srv" "geometry_msgs/Point:geometry_msgs/Quaternion:geometry_msgs/Pose:std_msgs/String:std_msgs/Int32"
)

get_filename_component(_filename "/home/asd/Downloads/3D_Perception/src/RoboND-Perception-Project/pr2_robot/srv/Grasp.srv" NAME_WE)
add_custom_target(_pr2_robot_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "pr2_robot" "/home/asd/Downloads/3D_Perception/src/RoboND-Perception-Project/pr2_robot/srv/Grasp.srv" "geometry_msgs/Point:geometry_msgs/Quaternion:geometry_msgs/Pose:std_msgs/String:std_msgs/Int32"
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/pr2_robot)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/pr2_robot\")")
  # install generated code
  install(
